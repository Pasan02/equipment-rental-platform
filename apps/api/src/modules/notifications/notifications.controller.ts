...
export class NotificationsController {
  ...
  @Get()
  @ApiOperation({ summary: 'List notifications for current user with pagination and status filter' })
  ...
  @ApiResponse({ status: 403, description: 'Forbidden access to another user notification' })
